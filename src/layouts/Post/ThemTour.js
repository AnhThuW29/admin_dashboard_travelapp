                      ...
                      <div className="bg-white px-4 py-5 sm:p-6">
                        <div className="grid grid-cols-6 gap-4">
                          ...
                          <div className="col-span-6 sm:col-span-12">
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setData({
                                  ...data,
                                  LoaiTour: e.target.value,
                                })
                              }
                            >
                              <option value="">Chọn Loại Tour </option>
                              {loaiTour &&
                                loaiTour.map((item, index) => (
                                  <option value={loaiTour[index]._id}>
                                    {loaiTour[index].TenLoaiTour}
                                  </option>
                                ))}
                            </select>
                          </div>
                          ...
                          <div className="col-span-6 sm:col-span-12">
                            ...
                            {data.HinhAnh && (
                              <img
                                src={URL.createObjectURL(data.HinhAnh)}
                                style={{
                                  marginTop: 10,
                                  height: "100px",
                                  width: "100px",
                            ...
                            <DialogActions>
                              ...
                              <Button
                                onClick={async () => {
                                  ...
                                  await axios
                                    .post(
                                      "http://localhost:9000/v1/tour/add",
                                      data,
                                      {
                                        headers: {
