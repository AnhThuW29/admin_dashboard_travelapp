        ...
        <div className="abc">
          <div className="pt-8 p-6 ">
            ...
            <div className="row-span-3 ">
              <div className="bg-center hidden overflow-hidden rounded-lg lg:block">
                <img
                ...
                <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-base text-gray-900">
                      <h3 className="italic text-gray-600">
                        Số điện thoại:
                        <span className="text-gray-900">{data.SDT}</span>
                      </h3>
                    </p>
                  </div>
                  ...
                  <div className="space-y-5">
                    <p className="text-base text-gray-900">{data.MoTa}</p>
                  </div>
                  <div className="mt-10">
                    <h2 className="text-lg font-bold tracking-tight text-gray-600 pb-2">
                      Lịch trình
